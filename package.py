...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "startercode.py"
 
        #Name of program
        self.project_name = "Aci Game"
        ...
        self.license = "Aci License"
 
        #Auhor of program
        self.author_name = "Me"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2015 Aci Schools."
 
        #Description
        self.project_description = "Simple Open Source 2D shooter"
